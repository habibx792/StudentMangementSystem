...
public:
    ...
    bool connect()
    {
        ...
        SQLCHAR *connStr = (SQLCHAR *)"DRIVER={ODBC Driver 17 for SQL Server};SERVER=localhost\\SQLEXPRESS;DATABASE=dsadb;Trusted_Connection=yes;TrustServerCertificate=yes;";
